...
# Emulate state persistence via cross-render query params to prevent refresh wipeouts
if "logged_in" not in st.session_state:
...
# =====================================================
# DATA RETRIEVAL PIPELINE (SCALPING ROBOT PRO M1 TIMEFRAME FOCUS)
# =====================================================
GOLD_SYMBOL = "XAUUSD"
GOLD_YF_TICKER = "GC=F"

st.sidebar.subheader("🎛️ Robot Matrix Controls")
selected_tf = st.sidebar.selectbox("Robot Matrix Interval Optimization", ["1m", "5m", "15m"], index=0) # Default optimized to M1
...
# Robot System Protection Feature Overlays
...
# =====================================================
# ROBOT PRO ENGINE INTEGRATION LAYER (M1 SCALPING MATRIX)
# =====================================================
def evaluate_scalping_matrix(df):
    ...
    # Apply Direction Control Rules from Robot Mode Selection Matrix
